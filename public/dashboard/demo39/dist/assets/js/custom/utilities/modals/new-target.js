...
var KTModalNewTarget = function () {
    ...
    return {
        init: function () {
            (i = document.querySelector("#insertModal")) && (o = new bootstrap.Modal(i), a = document.querySelector("#insertModal_form"), t = document.getElementById("insertModal_submit"), e = document.getElementById("insertModal_cancel"), new Tagify(a.querySelector('[name="tags"]'), {
