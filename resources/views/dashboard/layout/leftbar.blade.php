            ...
            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-3 mb-5">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link" href="../../demo39/dist/pages/pricing.html">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="javascript:void(0);">
                                ...
                                <span class="menu-title">Actual Problem</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="javascript:void(0);">
                                ...
                                <span class="menu-title">Action Problem</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="javascript:void(0);">
                                ...
                                <span class="menu-title">Activity by Contract</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('dailyactivity.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
